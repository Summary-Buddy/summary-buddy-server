...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<ApiResponse<?>> handleMethodArgumentNotValidException(
        ...
        return new ResponseEntity<>(
                ApiResponse.fail(CommonErrorType.REQUEST_VALIDATION, 400), HttpStatus.BAD_REQUEST);
    }
    ...
    protected ResponseEntity<ApiResponse<?>> handlerConstraintViolationException(
        ...
        log.error(ex.getMessage());
        return new ResponseEntity<>(
                ApiResponse.fail(CommonErrorType.VALIDATION_FAILED, 400), HttpStatus.BAD_REQUEST);
    }
